...
The original EDF specification has been expanded in several ways. EDF+ supports the addition of annotations and non-continuous recordings. The BDF format uses 24 bits per sample (in stead of the 16 bits per sample in EDF)
...
copied from, http://www.feschet.fr/?p=11 (This link seems to be removed)
